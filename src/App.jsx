  ...
  return (
    <div className="app-shell" {...sidebarSwipe}>
      ...
      <nav className="bottom-nav" aria-label="Bottom navigation">
        ...
        <a href="https://www.instagram.com/animetmtalks" target="_blank" rel="noopener noreferrer" className="bottom-nav-item" aria-label="Instagram">
        ...
        <button className="bottom-nav-item bottom-nav-home" onClick={() => navigate('/')} aria-label="Home">
